proto:
	...
	protoc --proto_path=./app/websocket-service/src/main/proto --java_out=./app/websocket-service/src/main/java --grpc-java_out=./app/websocket-service/src/main/java ./app/websocket-service/src/main/proto/*.proto
